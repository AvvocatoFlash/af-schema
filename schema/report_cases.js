module.exports = (mongoose) => {
    ...
    let reportCaseSchema = mongoose.Schema({
        total_case_sold_today:      { type: String },
        ...
        total_case_2credit:         { type: String },
        total_case_3credit:         { type: String },
        total_case_4credit:         { type: String },
        total_case_more_credit:     { type: String },
