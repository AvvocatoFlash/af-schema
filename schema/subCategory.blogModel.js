var categoryBlog = require('./category.blogModel');
var mongoose  = require('mongoose');
mongoose.plugin(schema => { schema.options.usePushEach = true });
const pick = require('lodash.pick');

var subCategoryBlogSchema = mongoose.Schema({
...
module.exports = mongoose.model('subCategoryBlog', subCategoryBlogSchema);